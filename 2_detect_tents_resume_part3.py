...
INPUT_CSV = 'filtered_dallas_mapillary_image_data_part3.csv'
OUTPUT_CSV = 'dallas_image_urls_with_preds_part3.csv'
INTERMEDIATE_CSV = 'dallas_intermediate_preds_part3.csv'
URL_COL = 'url'
...
df = pd.read_csv('dallas_intermediate_preds_part3.csv')
